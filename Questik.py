...
for i in range(15):
    ...
    if choise_day == 1:
        ...
        if choise_transport == 2:
            ...
            if choise_err >= 1:
                print("Я зря предупреждал тебя, недоумок")
                print("Ты проиграл")
                exit()
            choise_err += 1
            print("Нажимай на кнопки, которые тебе показывает игра.")
            print("Я тебя предупредил, ещё раз нажмешь не ту кнопку - проиграешь")
            go_home = 1
        if go_home != 1:
        ...
        if choise_food == 1:
            ...
            print("Нажимай на кнопки, которые тебе показывает игра.")
            print("Я тебя предупредил, ещё раз нажмешь не ту кнопку - проиграешь")
    elif choise_day == 5 and study_pts < 25:
        ...
        if choise_debt == 1:
            ...
            print("Нажимай на кнопки, которые тебе показывает игра.")
            print("Я тебя предупредил, ещё раз нажмешь не ту кнопку - проиграешь")
    elif choise_day == 6 and health_pts < 25:
